...
.line-y-axis {
  ...
  border-right: 1px solid var(--border-color, var(--border-color, #e2e8f0));
}
...
.task-input {
  flex: 1;
  padding: 0.75rem;
  border: 2px solid var(--border-color, var(--border-color, #e2e8f0));
  border-radius: 8px;
  font-size: 0.95rem;
...
.task-item:hover {
  border-color: var(--border-color, var(--border-color, #e2e8f0));
  background: var(--bg-surface, white);
}
