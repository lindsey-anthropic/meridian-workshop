            ...
            <div class="order-health-container">
              ...
              <div class="order-health-chart">
                <svg viewBox="0 0 200 200" class="donut-svg-compact">
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--color-rule)" stroke-width="25"/>
                  ...
                  <circle cx="100" cy="100" r="65" fill="none" stroke="var(--color-accent)" stroke-width="25"
...
export default {
  ...
  setup() {
    ...
    const categoryData = computed(() => {
      ...
      const singleColor = 'var(--color-ink-muted)' // Neutral slate gray color
...
.clickable-row:hover {
  background: var(--color-accent-softest) !important;
}
