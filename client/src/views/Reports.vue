              ...
              <tr v-for="q in quarterlyData" :key="q.quarter">
                ...
                <td>
                  <span :class="getFulfillmentClass(q.fulfillment_rate)">
                    {{ formatFulfillmentRate(q.fulfillment_rate) }}
                  </span>
                </td>
              </tr>
            </tbody>
...
export default {
  ...
  setup() {
    ...
    const getFulfillmentClass = (rate) => {
      if (rate === null || rate === undefined) return 'badge neutral'
      if (rate >= 90) return 'badge success'
      if (rate >= 75) return 'badge warning'
      return 'badge danger'
    }

    const formatFulfillmentRate = (rate) =>
      rate === null || rate === undefined ? 'N/A' : `${rate}%`
    ...
    return {
      ...
      getFulfillmentClass, formatFulfillmentRate,
