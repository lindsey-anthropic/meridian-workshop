    ...
    <div v-else>
      ...
      <div class="card">
        ...
        <div class="table-container">
          ...
          <div v-if="quarterlyData.length === 0" class="no-data">{{ t('reports.noData') }}</div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="chart-container">
          ...
          <div v-if="monthlyData.length === 0" class="no-data">{{ t('reports.noData') }}</div>
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const getBarHeight = (revenue) => {
      const maxRevenue = Math.max(0, ...monthlyData.value.map(m => m.revenue))
    ...
    // Reload whenever the shared filter bar changes
