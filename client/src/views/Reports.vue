...
export default {
  ...
  setup() {
    ...
    const getBarHeight = (revenue) => {
      ...
      return Math.round((revenue / max) * 200)
    }
    ...
    const getChangeValue = (current, previous) => {
      ...
      const formatted = Math.abs(change).toLocaleString(undefined, { style: 'currency', currency: currentCurrency.value, maximumFractionDigits: 0 })
