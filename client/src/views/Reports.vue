<template>
  <div class="reports">
    ...
    <div v-else-if="!quarterlyData.length && !monthlyData.length" class="loading">{{ t('reports.noData') }}</div>
    <div v-else>
      ...
      <div class="stats-grid">
        <div class="stat-card">
          <div class="stat-label">{{ t('reports.stats.ytdRevenue') }}</div>
        ...
        <div class="stat-card">
          <div class="stat-label">{{ t('reports.stats.ytdOrders') }}</div>
