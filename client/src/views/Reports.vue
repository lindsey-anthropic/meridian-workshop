...
export default {
  ...
  setup() {
    ...
    const { t } = useI18n()
    const { selectedLocation, selectedCategory, selectedPeriod } = useFilters()
    ...
    watch([selectedLocation, selectedCategory, selectedPeriod], loadData)
    ...
    const getChangeValue = (current, previous) => {
      ...
      const formatted = Math.abs(change).toLocaleString('en-US', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 })
