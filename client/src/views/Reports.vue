    ...
    <div v-else>
          ...
          <table class="reports-table">
            ...
            <tbody>
              <tr v-for="(q, index) in quarterlyData" :key="index">
                ...
                <td>${{ q.total_revenue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                <td>${{ q.avg_order_value.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
                <td>
      ...
      <div class="stats-grid">
        <div class="stat-card">
          ...
          <div class="stat-value">${{ totalRevenue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">Avg Monthly Revenue</div>
          <div class="stat-value">${{ avgMonthlyRevenue.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</div>
        </div>
        <div class="stat-card">
...
export default {
  ...
  setup() {
    ...
    const getBarHeight = (revenue) => (revenue / maxRevenue.value) * 200
    ...
    const getChangeValue = (current, previous) => {
      ...
      const abs = Math.abs(change).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })
      return change > 0 ? `+$${abs}` : change < 0 ? `-$${abs}` : '$0.00'
    }
    ...
    return {
      ...
      formatMonth, getBarHeight, getFulfillmentClass,
